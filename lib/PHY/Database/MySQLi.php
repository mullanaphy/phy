<?php
    ...
    class MySQLi extends \MySQLi implements \PHY\Database\IDatabase
    {
        ...
        public function last()
        {
            ...
            '<h2 style="border-bottom:solid 2px #ccf;color:#00f;font:bold 16px \'courier new\';margin:0 0 5px;padding:0;">SQL #', $this->count, ': ', str_replace(BASE_PATH, '/', $debug[$i]['file']), '" on line "', $debug[$i]['line'], '" - ', \PHY\Debug::timer(), ', server "', $this->host_info, '"</h2>',
