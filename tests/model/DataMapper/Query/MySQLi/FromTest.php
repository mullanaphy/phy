...
use \PHY\Model\DataMapper\Query\MySQLi\From;

    /**
     * Test our MySQLi From class.
     *
     * @package PHY\Tests\Model\DataMapper\Query\MySQLi\FromTest
     * @category PHY
    ...
    class FromTest extends \PHPUnit_Framework_TestCase
    {
        ...
        public function testFromLeftJoinComplex()
        {
            $from = new From;
            $from->from('Primary', 'p');
            $from->leftJoin('Secondary', 's', [['primary_id' => 'id'], ['secondary_other' => 'other']], ['secondary_and' => 'and']);
